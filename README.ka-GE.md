...
უვარგისი კოდის წერის თანამედროვე პრინციპები, რომლებსაც თქვენი პროექტი აუცილებლად უნდა აკმაყოფილებდას, რათა მის უვარგისობაში ეჭვი არავის შეეპაროს.
...
თუკი თქვენს საცავში (_რეპოზიტორი_) მკაცრად არის დაცული უვარგისი კოდის წერის პრინციპები, შეგიძლიათ ეს მიღწევა აღნიშნოთ შემდეგი ემბლემის გამოყენებით:
