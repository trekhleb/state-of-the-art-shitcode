...
### 💩 შექმენით ცვლადები, რომლებსაც არ გამოიყენებთ
...
### 💩 უნდა გქონდეთ კოდის მიუწვდომელი ნაწილები
...
განაახლეთ თქვენი დაქვემდებარებები ყოველი ახალი ინსტალაციისას უკონტროლოდ. რატომ ჩავრჩეთ წარსულთ, მოდი, გამოვიყენოთ ბიბლიოთეკების უახლესი (არასტაბილური) ვერსიები.
...
ეს არის ზედმეტი და არასაჭირო სამუშაო. 
